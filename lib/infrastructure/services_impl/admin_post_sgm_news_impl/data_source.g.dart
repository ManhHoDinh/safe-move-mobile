...
class _AdminPostSgmNewsDataSource implements AdminPostSgmNewsDataSource {
  ...
  @override
  Future<PostResponse> saveSgmNewsPost({required PostRequest request}) async {
  ...
  @override
  Future<SuccessResponse> deleteSgmNewsPost({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};

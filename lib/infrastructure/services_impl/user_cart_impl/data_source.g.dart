...
class _UserCartDataSource implements UserCartDataSource {
  _UserCartDataSource(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<PagingResponse<CartResponse>> getCarts({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PagingResponse<CartResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PagingResponse<CartResponse>.fromJson(_result.data!);
    return value;
  }

  @override
  Future<CartResponse> addCart({required CartCreateRequest request}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<SuccessResponse> deleteCart(
      {required CartDeleteRequest request}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<SuccessResponse> deleteCartAll() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;

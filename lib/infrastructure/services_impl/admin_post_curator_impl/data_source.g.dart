...
class _AdminPostCuratorDataSource implements AdminPostCuratorDataSource {
  ...
  @override
  Future<PostResponse> saveCuratorPost({required PostRequest request}) async {
  ...
  @override
  Future<SuccessResponse> deleteCuratorPost({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
